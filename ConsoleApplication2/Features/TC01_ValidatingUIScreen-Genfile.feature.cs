...
namespace AvidxBDDFramework.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("TC01-Validating the status change for a Check payment from Issued to Cleared base" +
        "d on the confirmation received from the bank")]
    public partial class TC01_ValidatingTheStatusChangeForACheckPaymentFromIssuedToClearedBasedOnTheConfirmationReceivedFromTheBankFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "TC01_ValidatingUIScreen-Genfile.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "TC01-Validating the status change for a Check payment from Issued to Cleared base" +
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01-Uploading BAI2 file to FTP location", new string[] {
                        "ftp",
                        "GenerateBAI2file"});
#line 4
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("02-Validating check status on AvidPay Internal portal")]
        [NUnit.Framework.CategoryAttribute("Web")]
        [NUnit.Framework.CategoryAttribute("Wait")]
        public virtual void _02_ValidatingCheckStatusOnAvidPayInternalPortal()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("02-Validating check status on AvidPay Internal portal", new string[] {
                        "Web",
                        "Wait"});
#line 10
this.ScenarioSetup(scenarioInfo);
