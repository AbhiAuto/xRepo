...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("01-Validating ClearStdCheck API when the payment status is 14", new string[] {
                        "api"});
#line 4
