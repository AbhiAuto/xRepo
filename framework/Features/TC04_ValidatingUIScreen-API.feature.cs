...
namespace AvidxBDDFramework.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("TC04-Validating the status change for a Check payment from Issued to Cleared base" +
        "d on the confirmation received from the bank")]
    public partial class TC04_ValidatingTheStatusChangeForACheckPaymentFromIssuedToClearedBasedOnTheConfirmationReceivedFromTheBankFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "TC04_ValidatingUIScreen-API.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "TC04-Validating the status change for a Check payment from Issued to Cleared base" +
